% Last time modified: 08/26/20

% Distributed to collaborators on August 11 2020.
% Update on 03/13/21: Added multidevice selection
...
% if handles.NFC.mode == 0 || handles.NFC.mode == 17 % Opt 00 or 11
%     
...
%         handles.NFC.DC0 = 50;
%         set(handles.DC_var,'Value',50);
%     else
%         handles.NFC.DC0 = temp;
%         set(handles.DC_var,'Value',temp);
%     end
